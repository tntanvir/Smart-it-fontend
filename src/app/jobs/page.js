...
export default function PublicJobsPage() {
  ...
  const handleAcceptTicket = async (ticketId) => {
    ...
    try {
      ...
      alert("Failed to accept ticket. Another technician might have claimed it or you are not authorized.");
      setAcceptingId(null);
    }
  };
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          <div>
            ...
            <p className="text-gray-500 dark:text-neutral-400 mt-1 transition-colors duration-200">Browse open support requests. Register as a technician to claim them.</p>
          </div>
          {!isAuthenticated && (
        ...
        {loading ? (
          ...
          <Card className="text-center py-16 border-dashed border-gray-300 dark:border-neutral-800">
            <CardContent>
              ...
              <h3 className="text-xl font-bold mb-2 text-gray-900 dark:text-white">No jobs available right now</h3>
          ...
          <div className="grid gap-4">
            ...
            {tickets.map(ticket => (
              <Card key={ticket.id} className="hover:shadow-md transition-all rounded-xl overflow-hidden border-gray-200 dark:border-neutral-800 dark:bg-neutral-900">
                  ...
                  <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6 w-full md:w-auto justify-between md:justify-end border-t md:border-t-0 pt-4 md:pt-0 border-gray-100 dark:border-neutral-800 shrink-0">
                    ...
                    <div className="flex flex-wrap gap-2 w-full sm:w-auto">
                      ...
                      <Button 
                        ...
                        className="bg-[#0052FF] hover:bg-[#0040CC] text-white rounded-full shadow-md shadow-blue-500/20 h-10 px-6"
                      >
